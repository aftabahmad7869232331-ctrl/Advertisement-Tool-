...
export default function StudioCoreCard() {
  return (
    <motion.div
      className="bm-studio-core bm-creative-preview relative mx-auto flex aspect-[1.04] max-w-[620px] flex-col overflow-hidden p-6 sm:p-8"
    ...
    >
      ...
      <div className="relative z-20 grid grid-cols-3 gap-3 sm:gap-4">
        {modules.map((item, index) => (
          <motion.div key={item.label} className="bm-mini-module" whileHover={{ y: -6, scale: 1.03 }}>
            <item.icon size={21} />
