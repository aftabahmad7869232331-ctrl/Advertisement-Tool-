// ============================================================
// 🚀 Brikes Maker Advertisement - Advance Super Pro v1.0.0
...
/** Extended user for Pro / Enterprise tiers. */
...
/** Extended campaign for Pro / Enterprise. */
...
export interface TeamMember {
  userId: string;
  user: Pick<ProUser, 'id' | 'email' | 'firstName' | 'lastName' | 'avatarUrl'>;
  role: TeamRole;
  joinedAt: Date;
  invitedBy: string;
  isActive: boolean;
